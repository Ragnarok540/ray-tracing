...
fn main() {
    ...
    let camera_center: Point3 = Point3::origin();
    ...
    let viewport_fl: Vec3 = Vec3::new(0.0, 0.0, focal_length);
    ...
    for j in 0..image_height {
        let remaining: usize = image_height - j;
        eprintln!("\rScanlines remaining: {remaining}");

        for i in 0..image_width {
            let pixel_center: Vec3 = pixel00_loc + (pixel_delta_u * i as f64) + (pixel_delta_v * j as f64);
